...
class XGradCAMProcessor:
    ...
    def compute_xgrad_cam_by_torchcam(self, input_tensor, class_idx=None):
        """
        Computes XGrad-CAM heatmap.
        ...
        Returns:
            numpy.ndarray: Heatmap of XGrad-CAM.
        """
        self.model.eval()
        ...
        # Compute XGrad-CAM
        weights = torch.sum(self.gradients.detach() * self.feature_maps.detach(), dim=(2, 3)).squeeze()
